...
class QamSignal(Signal):
    ...
    def __init__(self,
        ...
        if signal_setting.need_init:
            ...
            super(QamSignal, self).__init__(samples=samples,center_freq=signal_setting.center_freq,sps_in_fiber=signal_setting.sps_in_fiber,sps_dsp=signal_setting.sps_dsp,device=signal_setting.device)
